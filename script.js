...
const levels = [
    {
        ...
        name: "🌱 Основы",
        lessons: [
            { name: "Приветствия", words: ["Амар мэндэ", "Баяртай"] },
            { name: "Цвета", words: ["Шара", "Улаан"] },
            { name: "Семья", words: ["Аба", "Эхэ"] }
        ]
    },
    {
        id: 2,
        name: "📝 Описания",
        lessons: [
            { name: "Характеристики", words: ["Һайн", "Муухай"] },
            { name: "Размеры", words: ["Бага", "Ехэ"] }
        ]
    },
    {
        id: 3,
        name: "🏠 Предметы",
        lessons: [
            { name: "Вещи", words: ["Ном", "Һурагша"] },
            { name: "Свойства", words: ["Үндэр", "Богони", "Хүйтэн"] }
        ]
    }
];
